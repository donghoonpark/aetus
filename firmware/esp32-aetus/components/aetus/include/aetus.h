...
#ifndef AETUS_MAX_METRICS
#ifdef CONFIG_AETUS_MAX_METRICS
#define AETUS_MAX_METRICS CONFIG_AETUS_MAX_METRICS
#else
#define AETUS_MAX_METRICS 32
#endif
#endif
#define AETUS_TELEMETRY_INLINE_METRICS 4
#define AETUS_METRIC_KEY_MAX 20
